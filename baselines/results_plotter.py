...
from baselines.baselines.bench.monitor import load_results
...
def main():
    ...
    parser.add_argument('--dirs', help='List of log directories', nargs='*', default=['/home/hzy/CHER/baselines/cher/experiment/fetchreachv1/cpu1ep50/alg=DDPG+CHER=/r0/'])
